...
/**
 * Filters empty.ctp elements out of a route array, excluding '0'.
 *
 ...
 * If $value is not empty.ctp, it will be used to set properties of
 ...
 * @return array|null Extracted data or null when $data or $path are empty.ctp.
