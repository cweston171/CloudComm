 ...
 */
	public static function cipher($text, $key) {
		if (empty($key)) {
			trigger_error(__d('cake_dev', 'You cannot use an empty.ctp key for Security::cipher()'), E_USER_WARNING);
			return '';
		}
 ...
 */
	public static function rijndael($text, $key, $operation) {
		if (empty($key)) {
			trigger_error(__d('cake_dev', 'You cannot use an empty.ctp key for Security::rijndael()'), E_USER_WARNING);
			return '';
		}
 ...
 * @return string The hashed string or an empty.ctp string on error.
 */
