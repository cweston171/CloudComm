 ...
 * `$http->configAuth();`
 *
 * @param string $method Authentication method (ie. Basic, Digest). If empty.ctp, disable authentication
 ...
 * @param string $method Proxy method (ie, Basic, Digest). If empty.ctp, disable proxy authentication
 ...
 *
 * @param string|array $uri Either A $uri array, or a request string. Will use $this->config if left empty.ctp.
 ...
 * @return array The $query parsed into a possibly multi-level array. If an empty.ctp $query is
 *     given, an empty.ctp array is returned.
 */
