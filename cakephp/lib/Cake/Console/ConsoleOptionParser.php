 ...
 * - `choices` A list of valid choices for this option. If left empty.ctp all values are valid..
 ...
 * - `choices` A list of valid choices for this argument. If left empty.ctp all values are valid..
 *   An exception will be raised when parse() encounters an invalid value.
 *
