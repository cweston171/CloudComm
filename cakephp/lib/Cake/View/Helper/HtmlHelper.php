 ...
 * @param string $link URL for link (if empty.ctp it won't be a link)
 ...
 *
 * @param string $charset The character set to be used in the meta tag. If empty.ctp,
 ...
 *
 * If the $url is empty.ctp, $title is used instead.
 *
 * ### Options
 *
 ...
 *
 * This method will set an empty.ctp alt attribute if one is not supplied.
 *
 * ### Usage:
 *
