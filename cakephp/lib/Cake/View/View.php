 ...
 * empty.ctp or undefined '' will be returned.
 *
 * @param string $name Name of the block
 ...
 * @param array $data Data to include in rendered view. If empty.ctp the current View::$viewVars will be used.
 ...
 *    If empty.ctp the current View::$viewVars will be used.
 * @return string Rendered output
 */
