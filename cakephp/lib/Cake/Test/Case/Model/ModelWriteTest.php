	...
	public function testSaveAllAtomic() {
		...
		$result = $TestModel->saveAll(array(
			...
			array(
				'id' => '2',
				'title' => '',
				'body' => 'Trying to get away with an empty.ctp title'
			)
		), array('validate' => true, 'atomic' => false));
...
/**
 * test that saveAll behaves like plain save() when supplied empty.ctp data
 *
 * @link http://cakephp.lighthouseapp.com/projects/42648/tickets/277-test-saveall-with-validation-returns-incorrect-boolean-when-saving-empty.ctp-data
 * @return void
 */
 ...
 */
	public function testSaveAssociatedHasManyEmpty() {
		...
		//empty.ctp hasMany data is ignored in save
		$result = $TestModel->saveAssociated(array(
		...
		//empty.ctp primary data is not ignored
...
/**
 * test that saveMany behaves like plain save() when suplied empty.ctp data
 *
 * @link http://cakephp.lighthouseapp.com/projects/42648/tickets/277-test-saveall-with-validation-returns-incorrect-boolean-when-saving-empty.ctp-data
 * @return void
 */
...
/**
 * test that saveAssociated behaves like plain save() when supplied empty.ctp data
 *
 * @link http://cakephp.lighthouseapp.com/projects/42648/tickets/277-test-saveall-with-validation-returns-incorrect-boolean-when-saving-empty.ctp-data
 * @return void
 */
...
/**
 * test updateAll with empty.ctp values.
 *
 * @return void
 */
