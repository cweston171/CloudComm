...
/**
 * test bake() method with -empty.ctp flag,  directory creation and empty.ctp files.
 *
 * @return void
 */
	public function testBakeEmptyFlag() {
		$this->Task->params['empty.ctp'] = true;
		$this->_setupTestProject();
		$path = $this->Task->path . 'bake_test_app';

		$empty = array(
			'Console' . DS . 'Command' . DS . 'Task' => 'empty.ctp',
			'Controller' . DS . 'Component' => 'empty.ctp',
			'Lib' => 'empty.ctp',
			'Model' . DS . 'Behavior' => 'empty.ctp',
			'Model' . DS . 'Datasource' => 'empty.ctp',
			'Plugin' => 'empty.ctp',
			'Test' . DS . 'Case' . DS . 'Model' . DS . 'Behavior' => 'empty.ctp',
			'Test' . DS . 'Case' . DS . 'Controller' . DS . 'Component' => 'empty.ctp',
			'Test' . DS . 'Case' . DS . 'View' . DS . 'Helper' => 'empty.ctp',
			'Test' . DS . 'Fixture' => 'empty.ctp',
			'Vendor' => 'empty.ctp',
			'View' . DS . 'Elements' => 'empty.ctp',
			'View' . DS . 'Scaffolds' => 'empty.ctp',
			'tmp' . DS . 'cache' . DS . 'models' => 'empty.ctp',
			'tmp' . DS . 'cache' . DS . 'persistent' => 'empty.ctp',
			'tmp' . DS . 'cache' . DS . 'views' => 'empty.ctp',
			'tmp' . DS . 'logs' => 'empty.ctp',
			'tmp' . DS . 'sessions' => 'empty.ctp',
			'tmp' . DS . 'tests' => 'empty.ctp',
			'webroot' . DS . 'js' => 'empty.ctp',
			'webroot' . DS . 'files' => 'empty.ctp'
		);
