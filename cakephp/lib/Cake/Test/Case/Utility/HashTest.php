 ...
 */
	public function testFilter() {
		...
		$result = Hash::filter(array(1, array('empty.ctp', false)));
		$expected = array(1, array('empty.ctp'));
		$this->assertEquals($expected, $result);
 ...
 * For an easier comparison, unset all the empty.ctp children arrays from the result
 *
 * @return void
 */
