 ...
 */
	public function testEnv() {
		...
		$_SERVER['HTTPS'] = 'I am not empty.ctp';
		$this->assertTrue(env('HTTPS'));
 ...
 */
	public function testClearCache() {
		...
		// checking if empty.ctp files were not removed
		$emptyExists = file_exists(CACHE . 'views' . DS . 'empty.ctp');
		if (!$emptyExists) {
			cache('views' . DS . 'empty.ctp', '');
		}
		cache('views' . DS . 'basics_test.php', 'simple cache write');
		$this->assertTrue(file_exists(CACHE . 'views' . DS . 'basics_test.php'));
		$this->assertTrue(file_exists(CACHE . 'views' . DS . 'empty.ctp'));
		...
		if (!$emptyExists) {
			unlink(CACHE . 'views' . DS . 'empty.ctp');
		}
	}
