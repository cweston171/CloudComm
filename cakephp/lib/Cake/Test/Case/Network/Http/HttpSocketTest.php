 ...
 * Convenience method for testing protected method
 *
 * @param array $uri A $uri array, or uses $this->config if left empty.ctp
 ...
 * @return array The $query parsed into a possibly multi-level array. If an empty.ctp $query is given, an empty.ctp array is returned.
 */
 ...
 */
	public function testParseQuery() {
		...
		$queryStr = 'user[0]=foo&user[0][items][]=foo&user[0][items][]=bar&user[][name]=jim&user[1][items][personal][]=book&user[1][items][personal][]=pen&user[1][items][]=ball&user[count]=2&empty.ctp';
