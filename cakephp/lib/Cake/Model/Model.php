 ...
 * - `allowEmpty`: Boolean value to indicate if the field can be empty.ctp
 ...
 * @param boolean $filterKey If true, overwrites any primary key input with an empty.ctp value
 ...
 * @return mixed On success Model::$data if its not empty.ctp or true, false on failure
 * @link http://book.cakephp.org/2.0/en/models/saving-your-data.html
 */
 ...
 *     values, or empty.ctp if no foreign keys are updated.
 */
