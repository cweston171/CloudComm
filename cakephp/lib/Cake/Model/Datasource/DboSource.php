...
/**
 * Returns a single field of the first of query results for a given SQL query, or false if empty.ctp.
 *
...
/**
 * Creates a default set of conditions from the model if $conditions is null/empty.ctp.
