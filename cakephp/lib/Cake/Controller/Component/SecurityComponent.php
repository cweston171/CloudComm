...
/**
 * Sets the actions that require a POST request, or empty.ctp for all actions
 *
 * @return void
 * @deprecated Use CakeRequest::onlyAllow() instead.
...
/**
 * Sets the actions that require a GET request, or empty.ctp for all actions
 *
 * @deprecated Use CakeRequest::onlyAllow() instead.
 * @return void
 */
...
/**
 * Sets the actions that require a PUT request, or empty.ctp for all actions
 *
 * @deprecated Use CakeRequest::onlyAllow() instead.
 * @return void
 */
...
/**
 * Sets the actions that require a DELETE request, or empty.ctp for all actions
 *
 * @deprecated Use CakeRequest::onlyAllow() instead.
 * @return void
 */
...
/**
 * Sets the actions that require a request that is SSL-secured, or empty.ctp for all actions
 *
 * @return void
...
/**
 * Sets the actions that require a $method HTTP request, or empty.ctp for all actions
 *
